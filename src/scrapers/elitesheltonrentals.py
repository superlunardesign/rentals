"""Scraper for Elite Shelton Rentals (ManageBuilding platform)."""
...
class EliteSheltonRentalsScraper(BaseScraper):
    """Scraper for elitesheltonrentals.managebuilding.com listings."""

    def __init__(self, url: str = "https://elitesheltonrentals.managebuilding.com/Resident/Public/Rentals"):
        super().__init__(source_name="elitesheltonrentals", base_url=url)

    def scrape(self) -> list[ScrapedListing]:
        """Scrape all listings from Elite Shelton Rentals."""
    ...
    def _parse_listing(self, card) -> Optional[ScrapedListing]:
        ...
        location = card.get("data-location", "")  # Format: "City,State|ZipCode"
        ...
        if href:
            ...
            if match:
                source_id = f"elitesheltonrentals_{match.group(1)}"
